...
Un profil est un nom associé à des parties et des grilles créées par l'utilisateur en question. Une fois le profil, ne nécessitant pas de mot de passe, chargé, l'utilisateur à accès à toutes ses données.\\
...
\\
La partie terminée, deux choix s'afficheront:
...
% Sauvegarder une partie est assez simple, lorsque le joueur choisi cette option il lui est demandé de choisir un nom de partie (ou de laisser celui par défaut) et de valider (ou d'annuler).
